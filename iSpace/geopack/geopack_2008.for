...
C
C
      COMMON /GEOPACK4/ G(105),H(105),REC(105)

      DIMENSION A(14),B(14)

Cf2py intent(in) :: XGSW,YGSW,ZGSW
Cf2py intent(out) :: HXGSW,HYGSW,HZGSW
...
Cf2py intent(out) :: BR,BTHETA,BPHI
...
C  AUTHOR: N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ AA(10),SPS,CPS,BB(22)
      COMMON /GEOPACK4/ G(105),H(105),REC(105)
C

Cf2py intent(in) :: XGSW,YGSW,ZGSW
Cf2py intent(out) :: BXGSW,BYGSW,BZGSW
...
Cf2py intent(in) :: IYEAR,IDAY,IHOUR,MIN,ISEC
Cf2py intent(out) :: GST,SLONG,SRASN,SDEC
...
Cf2py intent(inout) :: R,THETA,PHI,X,Y,Z
Cf2py intent(in) :: J
...
Cf2py intent(in) :: THETA,PHI,BR,BTHETA,BPHI
...
Cf2py intent(in) :: X,Y,Z,BX,BY,BZ
Cf2py intent(out) :: BR,BTHETA,BPHI
...
C                         INTO THE COMMON BLOCKS /GEOPACK3/ AND /GEOPACK4/)
C
...
C
C
C     SAVE ISW # This command exists in D:\research\Version_v01\gxnchu\python\tsyg\geopack\geopack_2008.f
C

Cf2py intent(in) :: IYEAR,IDAY,IHOUR,MIN,ISEC
Cf2py intent(in) :: VGSEX,VGSEY,VGSEZ

      COMMON /GEOPACK3/ ST0,CT0,SL0,CL0,CTCL,STCL,CTSL,STSL,SFI,CFI,
     * SPS,CPS,DS3,CGST,SGST,PSI,A11,A21,A31,A12,A22,A32,A13,A23,A33,
     * E11,E21,E31,E12,E22,E32,E13,E23,E33
C
C  THE COMMON BLOCK /GEOPACK3/ CONTAINS ELEMENTS OF THE ROTATION MATRICES AND OTHER
C   PARAMETERS RELATED TO THE COORDINATE TRANSFORMATIONS PERFORMED BY THIS PACKAGE
C
      COMMON /GEOPACK4/ G(105),H(105),REC(105)
C
C  THE COMMON BLOCK /GEOPACK4/ CONTAINS COEFFICIENTS OF THE IGRF FIELD MODEL, CALCULATED
...
C      DATA ISW /0/ # # This command exists in D:\research\Version_v01\gxnchu\python\tsyg\geopack\geopack_2008.f
C
...
C
      COMMON /GEOPACK3/ AAA(25),E11,E21,E31,E12,E22,E32,E13,E23,E33
Cf2py intent(inout) :: XGSW,YGSW,ZGSW
Cf2py intent(inout) :: XGSE,YGSE,ZGSE
Cf2py intent(in) :: J
C
...
C
c==================================================================================
      SUBROUTINE GSW2GSE_08 (XGSW,YGSW,ZGSW,XGSE,YGSE,ZGSE)
c     This routine convert GSW to GSE

      COMMON /GEOPACK3/ AAA(25),E11,E21,E31,E12,E22,E32,E13,E23,E33

Cf2py intent(in) :: XGSW,YGSW,ZGSW
Cf2py intent(out) :: XGSE,YGSE,ZGSE
...
c==================================================================================
      SUBROUTINE GSE2GSW_08 (XGSW,YGSW,ZGSW,XGSE,YGSE,ZGSE)		  
c     This routine convert GSE to GSW
      COMMON /GEOPACK3/ AAA(25),E11,E21,E31,E12,E22,E32,E13,E23,E33

Cf2py intent(in) :: XGSE,YGSE,ZGSE
Cf2py intent(out) :: XGSW,YGSW,ZGSW
...
C   AUTHOR:  N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ ST0,CT0,SL0,CL0,CTCL,STCL,CTSL,STSL,AB(26)

Cf2py intent(inout) :: XGEO,YGEO,ZGEO
Cf2py intent(inout) :: XMAG,YMAG,ZMAG
Cf2py intent(in) :: J
...
c
c=========================================================================================
      SUBROUTINE GEO2MAG_08 (XGEO,YGEO,ZGEO,XMAG,YMAG,ZMAG)
c     This routine convert GEO to MAG
      COMMON /GEOPACK3/ ST0,CT0,SL0,CL0,CTCL,STCL,CTSL,STSL,AB(26)

Cf2py intent(in) :: XGEO,YGEO,ZGEO
Cf2py intent(out) :: XMAG,YMAG,ZMAG
...
c=========================================================================================
      SUBROUTINE MAG2GEO_08 (XGEO,YGEO,ZGEO,XMAG,YMAG,ZMAG)
c     This routine convert MAG to GEO
      COMMON /GEOPACK3/ ST0,CT0,SL0,CL0,CTCL,STCL,CTSL,STSL,AB(26)

Cf2py intent(in) :: XMAG,YMAG,ZMAG
Cf2py intent(out) :: XGEO,YGEO,ZGEO
...
C     AUTHOR:  N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ A(13),CGST,SGST,B(19)
C

Cf2py intent(in,out) :: XGEI,YGEI,ZGEI,XGEO,YGEO,ZGEO
Cf2py intent(in) :: J
...
C
      ...
      END
c=========================================================================================
      SUBROUTINE GEI2GEO_08 (XGEI,YGEI,ZGEI,XGEO,YGEO,ZGEO)
      COMMON /GEOPACK3/ A(13),CGST,SGST,B(19)
c     This routine convert GEI to GEO

Cf2py intent(in) :: XGEI,YGEI,ZGEI
Cf2py intent(out) :: XGEO,YGEO,ZGEO 
...
c=========================================================================================
      SUBROUTINE GEO2GEI_08 (XGEI,YGEI,ZGEI,XGEO,YGEO,ZGEO)
      COMMON /GEOPACK3/ A(13),CGST,SGST,B(19)
c     This routine convert GEO to GEI

Cf2py intent(in) :: XGEO,YGEO,ZGEO 
Cf2py intent(out) :: XGEI,YGEI,ZGEI
...
C     AUTHOR:  N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ A(8),SFI,CFI,B(24)
C

Cf2py intent(in,out) :: XMAG,YMAG,ZMAG,XSM,YSM,ZSM
Cf2py intent(in) :: J
...
C
c=========================================================================================
      SUBROUTINE MAG2SM_08 (XMAG,YMAG,ZMAG,XSM,YSM,ZSM)
      COMMON /GEOPACK3/ A(8),SFI,CFI,B(24)
c     This routine convert MAG to SM

Cf2py intent(in) :: XMAG,YMAG,ZMAG
Cf2py intent(out) :: XSM,YSM,ZSM
...
c=========================================================================================
      SUBROUTINE SM2MAG_08 (XMAG,YMAG,ZMAG,XSM,YSM,ZSM)
      COMMON /GEOPACK3/ A(8),SFI,CFI,B(24)
c     This routine convert SM to MAG

Cf2py intent(in) :: XSM,YSM,ZSM
Cf2py intent(out) :: XMAG,YMAG,ZMAG
...
C     AUTHOR:  N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ A(10),SPS,CPS,B(22)
...
C
c=========================================================================================
      SUBROUTINE SM2GSW_08 (XSM,YSM,ZSM,XGSW,YGSW,ZGSW)
      COMMON /GEOPACK3/ A(10),SPS,CPS,B(22)
c     This routine convert SM to GSW
...
Cf2py intent(out) :: XGSW,YGSW,ZGSW
      ...
      END      
c=========================================================================================
      SUBROUTINE GSW2SM_08 (XSM,YSM,ZSM,XGSW,YGSW,ZGSW)
      COMMON /GEOPACK3/ A(10),SPS,CPS,B(22)
c     This routine convert GSW to SM
...
C     AUTHOR:  N. A. TSYGANENKO
C
      COMMON /GEOPACK3/ AA(16),A11,A21,A31,A12,A22,A32,A13,A23,A33,B(9)
...
C
c=========================================================================================
      SUBROUTINE GEO2GSW_08 (XGEO,YGEO,ZGEO,XGSW,YGSW,ZGSW)
      COMMON /GEOPACK3/ AA(16),A11,A21,A31,A12,A22,A32,A13,A23,A33,B(9)
c     This routine convert GEO to GSW
...
Cf2py intent(out) :: XGSW,YGSW,ZGSW
      ...
      END      
c=========================================================================================
      SUBROUTINE GSW2GEO_08 (XGEO,YGEO,ZGEO,XGSW,YGSW,ZGSW)
      COMMON /GEOPACK3/ AA(16),A11,A21,A31,A12,A22,A32,A13,A23,A33,B(9)
c     This routine convert GSW to GEO
...
C
c=========================================================================================
      SUBROUTINE GEOD2GEO_08 (H,XMU,R,THETA)
      DATA R_EQ, BETA /6378.137, 6.73949674228E-3/
      DATA TOL /1.E-6/
c     This routine convert GEOD to GEO

Cf2py intent(in) :: H,XMU
Cf2py intent(out) :: R,THETA
...
c=========================================================================================
      SUBROUTINE GEO2GEOD_08 (H,XMU,R,THETA)
      DATA R_EQ, BETA /6378.137, 6.73949674228E-3/
      DATA TOL /1.E-6/
c     This routine convert GEO to GEOD

Cf2py intent(in) :: R,THETA
Cf2py intent(out) :: H,XMU
...
C
      COMMON /GEOPACK3/ A(12),DS3,BB(2),PSI2,CC(18)
      COMMON /GEOPACK1/ DDD(15),PSI,EEE(19)

C       EXTERNAL EXNAME,INNAME
      CHARACTER EXNAME*(*),INNAME*(*)

Cf2py intent(in) ::  X, Y, Z, IOPT,PARMOD
Cf2py intent(in) ::  EXNAME,INNAME
Cf2py intent(out) :: R1,R2,R3

      IF (EXNAME.eq.'T89') THEN
        CALL T89D_SP(IOPT,PARMOD,PSI,X,Y,Z,BXGSM,BYGSM,BZGSM) 
      ELSE IF (EXNAME.eq.'T96') THEN
        CALL T96_01(IOPT,PARMOD,PSI,X,Y,Z,BXGSM,BYGSM,BZGSM)        
      ELSE IF (EXNAME.EQ.'T01') THEN
        CALL T01_01(IOPT,PARMOD,PSI,X,Y,Z,BXGSM,BYGSM,BZGSM)
      ELSE IF (EXNAME.EQ.'T04') THEN
        CALL T04_s(IOPT,PARMOD,PSI,X,Y,Z,BXGSM,BYGSM,BZGSM)     
      ENDIF
      IF (INNAME.eq.'IGRF_GSM') THEN
        CALL IGRF_GSM(X,Y,Z,HXGSM,HYGSM,HZGSM)
      ELSE IF (INNAME.eq.'DIP') THEN
C      sub-routine DIP is from geopack_2005.for
        CALL DIP(X,Y,Z,HXGSM,HYGSM,HZGSM)
      ENDIF
...
C
      DIMENSION PARMOD(10)
      COMMON /GEOPACK3/ A(12),DS3,B(21)
C       EXTERNAL EXNAME,INNAME
      CHARACTER EXNAME*(*),INNAME*(*)

Cf2py intent(in) ::  DS,DSMAX,ERRIN, IOPT,PARMOD
Cf2py intent(in) ::  EXNAME,INNAME
...
C      IN THE COMMON BLOCK /GEOPACK3/ (IN ITS 11th AND 12th ELEMENTS, RESPECTIVELY).
...
C
      ...
      COMMON /GEOPACK3/ AA(12),DD,BB(21)
C       EXTERNAL EXNAME,INNAME
      CHARACTER EXNAME*(*),INNAME*(*)
...
Cf2py intent(out),dimension(LMAX), depend(LMAX) :: XX,YY,ZZ
...
Cf2py intent(in) ::  XN_PD, VEL, BZIMF
Cf2py intent(in) ::  XGSW, YGSW, ZGSW
Cf2py intent(out) :: XMGNP, YMGNP, ZMGNP
